...
photon_tree.Branch("pT",  pT,  'var/D')
photon_tree.Branch("phi", phi, 'var/D')
photon_tree.Branch("theta", theta, 'var/D')
photon_tree.Branch("E_truth",  E_truth,  'var/D')
photon_tree.Branch("pT_truth",  pT_truth,  'var/D')
photon_tree.Branch("phi_truth", phi_truth, 'var/D')
photon_tree.Branch("theta_truth", theta_truth, 'var/D')
photon_tree.Branch("E_ECal_Barrel", E_ECal_Barrel, 'var/D')
photon_tree.Branch("E_ECal_Endcap", E_ECal_Endcap, 'var/D')
photon_tree.Branch("E_HCal_Barrel", E_HCal_Barrel, 'var/D')
photon_tree.Branch("E_HCal_Endcap", E_HCal_Endcap, 'var/D')
