...
parser.add_option('-p', '--inFilePrefix', help = '--inFilePrefix kaonGun_test', 
                  type=str, default='kaonGun_test')
parser.add_option('-o', '--outFile', help='--output file name', 
                  type=str, default = 'kaon_jet_study_test')
...
E = array('d', [0]) #reconstructed kaon energy
pT = array('d', [0]) #reconstructed kaon pT
phi = array('d', [0]) #reconstructed kaon phi
theta = array('d', [0]) #reconstructed kaon theta
E_truth = array('d', [0]) #true kaon energy
pT_truth = array('d', [0]) #true kaon pT
phi_truth = array('d', [0]) #true kaon phi
theta_truth = array('d', [0]) #true kaon theta
kaon_tree.Branch("E",  E,  'var/D')
kaon_tree.Branch("pT",  pT,  'var/D')
kaon_tree.Branch("phi", phi, 'var/D')
kaon_tree.Branch("theta", theta, 'var/D')
kaon_tree.Branch("E_truth",  E_truth,  'var/D')
kaon_tree.Branch("pT_truth",  pT_truth,  'var/D')
kaon_tree.Branch("phi_truth", phi_truth, 'var/D')
...
for file in to_process:
    ...
    for ievt, event in enumerate(reader):
        ...
        for pfo in pfoCollection:
            ...
            #if dR < minDREM and abs(pfo.getType()) == 211: #closest reconstructed kaon #I FEEL LIKE THIS SHOULD BE TYPE 22
